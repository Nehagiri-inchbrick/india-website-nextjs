...
export const html = `
      ...
      <div class="ex-hero-stage">
        <div class="ex-hero-media" aria-hidden="true">
          <video class="ex-hero-video" id="exBannerVideo" muted loop playsinline autoplay preload="auto"
            poster="https://images.unsplash.com/photo-1507992781348-31024be7976e?auto=format&fit=crop&w=1800&q=90">
            <source id="exBannerVideoSrc" src="https://videos.pexels.com/video-files/3209676/3209676-hd_1920_1080_25fps.mp4" type="video/mp4">
          </video>
          <img class="ex-hero-bg" id="exBannerImg" src="https://images.unsplash.com/photo-1507992781348-31024be7976e?auto=format&fit=crop&w=1800&q=90" alt="">
        </div>
        ...
        <div class="ex-hero-content">
          ...
          <p class="ex-hero-sub" id="exBannerSub">Meet top developers live at India&apos;s flagship overseas property expo.</p>
  ...
  <!-- ═══ UPCOMING TIMELINE ═══ -->
  <section class="ex-section ex-upcoming-board" id="ex-upcoming">
    <div class="ex-cal-decor" aria-hidden="true">
      <div class="ex-cal-map"></div>
      <div class="ex-cal-skyline"></div>
      <div class="ex-cal-flight">
        <i class="fas fa-plane"></i>
      </div>
    </div>
    <div class="ex-wrap">
      <header class="ex-cal-head">
        <span class="ex-cal-kicker">Expo Calendar</span>
        <h2>Upcoming <span>Expos</span></h2>
        <p class="ex-head-sub" id="exUpcomingSub">Plan your city stop. Switch months to explore investor expos worldwide.</p>
      </header>

      <div class="ex-cal-board">
        <div class="ex-cal-months" id="exCalMonths" role="tablist" aria-label="Filter by month"></div>

        <ol class="ex-cal-grid" id="exTimeline" aria-label="Upcoming expos"></ol>

   
        <p class="ex-cal-hint" id="exTlHint">More destinations are added through the year — reserve early for priority access.</p>
      </div>
    </div>
  </section>
  ...
  <section class="ex-section ex-past-section" id="ex-past">
    <div class="ex-past-decor" aria-hidden="true">
      <div class="ex-past-map"></div>
      <div class="ex-past-skyline"></div>
    </div>
    <div class="ex-wrap">
      <header class="ex-past-head">
        <span class="ex-past-kicker"><span class="ex-past-kicker-line"></span> Our Journey <span class="ex-past-kicker-line"></span></span>
        <h2>Our <span class="ex-title-accent">Past</span> Events</h2>
        <p>A glimpse of the global property expos we&apos;ve proudly hosted.</p>
        <span class="ex-past-head-rule" aria-hidden="true"></span>
      </header>

      <div class="ex-past-carousel" id="exPastFeature" aria-live="polite">
        <div class="ex-past-track" id="exPastTrack"></div>
      </div>

      <div class="ex-past-foot">
        <button type="button" class="ex-past-nav-btn" id="exPastPrev" aria-label="Previous past expos"><i class="fas fa-arrow-left"></i></button>
        <div class="ex-past-coming">
          <span class="ex-past-coming-ico" aria-hidden="true"><i class="fas fa-calendar-alt"></i></span>
          <div>
            <strong>More Events Coming Ahead</strong>
            <span>Stay tuned for our upcoming global expos.</span>
          </div>
          <a class="ex-past-coming-link" href="#ex-upcoming" aria-label="View upcoming expos"><i class="fas fa-arrow-right"></i></a>
        </div>
        <button type="button" class="ex-past-nav-btn" id="exPastNext" aria-label="Next past expos"><i class="fas fa-arrow-right"></i></button>
      </div>
    </div>
  </section>

  <!-- ═══ TESTIMONIALS ═══ -->
  <section class="ex-section ex-stories" id="ex-stories">
    <div class="ex-stories-decor" aria-hidden="true"></div>
    <div class="ex-wrap">
      <header class="ex-stories-head">
        <span class="ex-stories-kicker"><span class="ex-stories-kicker-line"></span> Visitor Stories <span class="ex-stories-kicker-line"></span></span>
        <h2>What Buyers Say About Our <span>Expos</span></h2>
        <p>Real voices from NRIs and investors who walked our floors and left with clarity.</p>
      </header>

      <div class="ex-quote-grid">
        <blockquote class="ex-quote">
          <div class="ex-quote-top">
            <span class="ex-quote-mark" aria-hidden="true">“</span>
            <span class="ex-quote-stars" aria-label="5 star review">
          ...
          <footer>
            <span class="ex-quote-avatar" aria-hidden="true">RM</span>
            <div>
              <strong>Rahul Mehta</strong>
              <span>NRI · Toronto Expo 2025</span>
            </div>
            <span class="ex-quote-city">Toronto</span>
          </footer>
        </blockquote>

        <blockquote class="ex-quote is-featured">
          <div class="ex-quote-top">
            <span class="ex-quote-mark" aria-hidden="true">“</span>
            <span class="ex-quote-stars" aria-label="5 star review">
              <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
          ...
          <footer>
            <span class="ex-quote-avatar" aria-hidden="true">PS</span>
            <div>
              <strong>Priya &amp; Arjun Shah</strong>
              <span>Investors · Dubai Expo 2024</span>
            </div>
            <span class="ex-quote-city">Dubai</span>
          </footer>
        </blockquote>
        ...
        <blockquote class="ex-quote">
          ...
          <footer>
            <span class="ex-quote-avatar" aria-hidden="true">AK</span>
            <div>
              <strong>Ananya Krishnan</strong>
              <span>NRI · London Expo 2024</span>
            </div>
            <span class="ex-quote-city">London</span>
          </footer>
        </blockquote>
      </div>
    </div>
  ...
  <section class="ex-gallery-section" id="ex-gallery" aria-label="Expo gallery">
    <div class="ex-gal-atmosphere" aria-hidden="true">
      <span class="ex-gal-glow ex-gal-glow--a"></span>
      <span class="ex-gal-glow ex-gal-glow--b"></span>
      <span class="ex-gal-gridlines"></span>
    </div>

    <div class="ex-gal-wrap">
      <header class="ex-gal-head">
        <span class="ex-gal-kicker">On The Floor</span>
        <div class="ex-gal-head-row">
          <h2>Captured at the <span>Expo</span></h2>
          <p class="ex-gal-head-sub">Halls, launches, lounges, and the buyers who made each city stop unforgettable.</p>
        </div>
      </header>

      <div class="ex-gal-board">
        <aside class="ex-gal-rail">
          <span class="ex-gal-giant" id="exGalGiant" aria-hidden="true">01</span>
          <div class="ex-gal-rail-copy">
            <span class="ex-gal-counter" id="exGalCounter">01 / 06</span>
            <p class="ex-gal-label" id="exGalLabel">Main Hall</p>
            <p class="ex-gal-place" id="exGalPlace">Toronto Expo</p>
          </div>
          <div class="ex-gal-controls">
            <button type="button" class="ex-gal-nav ex-gal-nav--prev" id="exGalPrev" aria-label="Previous scene"><i class="fas fa-arrow-left"></i></button>
            <button type="button" class="ex-gal-nav ex-gal-nav--next" id="exGalNext" aria-label="Next scene"><i class="fas fa-arrow-right"></i></button>
          </div>
          <div class="ex-gal-progress" aria-hidden="true">
            <span class="ex-gal-progress-bar" id="exGalProgress"></span>
          </div>
        </aside>

        <div class="ex-gal-stage">
          <div class="ex-gal-viewport-shell">
            <span class="ex-gal-frame-tag" aria-hidden="true">Live Floor</span>
            <div class="ex-gal-viewport">
              <div class="ex-gal-track" id="exGalTrack">
                ...
                <article class="ex-gal-slide" data-title="Launch Stage" data-place="Keynote Arena">
                  <img src="https://images.unsplash.com/photo-1492684223066-81342ee5ff30?auto=format&fit=crop&w=2000&q=90" alt="Launch stage" loading="lazy">
                </article>
        ...
        <div class="ex-gal-film" aria-hidden="false">
          <span class="ex-gal-film-label">Scenes</span>
