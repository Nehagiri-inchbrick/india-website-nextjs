...
export const html = `
  ...
  <section class="ex-section" id="ex-upcoming">
    <div class="ex-wrap">
      <header class="ex-head">
        <span class="ex-tag">Global Calendar</span>
        <h2>Expo <span class="ex-title-accent">Timeline</span></h2>
        <p class="ex-head-sub" id="exUpcomingSub">Upcoming and live expos worldwide — filter by region and reserve your VIP pass.</p>
      </header>
