...
export const html = `
  ...
  <section class="ex-section ex-upcoming-board" id="ex-upcoming">
    <div class="ex-wrap">
      <header class="ex-cal-head">
        ...
        <p class="ex-head-sub" id="exUpcomingSub">Switch months to explore live and upcoming investor expos worldwide.</p>
      </header>
      ...
      <div class="ex-cal-board">
        ...
        <div class="ex-cal-foot">
          <p id="exTlHint">More destinations are added through the year — reserve early for priority access.</p>
          <button type="button" class="ex-btn ex-btn--fill openRegisterModalBtn" id="exCalReserve" data-event="">
            Reserve Your Slot <i class="fas fa-arrow-right" aria-hidden="true"></i>
          </button>
        </div>
      </div>
    </div>
  ...
  <section class="ex-section ex-past-section" id="ex-past">
    <div class="ex-past-map" aria-hidden="true"></div>
    <div class="ex-wrap">
      <header class="ex-past-head">
        <span class="ex-past-kicker"><span class="ex-past-kicker-line"></span> Our Journey of Excellence <span class="ex-past-kicker-line"></span></span>
        <h2>Where We've <span class="ex-title-accent">Been</span></h2>
        <p>Reliving the highlights of our global property expos that have connected thousands with exceptional real estate opportunities.</p>
      </header>

      <div class="ex-past-timeline-row">
        <button type="button" class="ex-past-nav-btn" id="exPastPrev" aria-label="Previous expo"><i class="fas fa-chevron-left"></i></button>
        <ol class="ex-past-years" id="exPastYears" aria-label="Past expo timeline"></ol>
        <button type="button" class="ex-past-nav-btn" id="exPastNext" aria-label="Next expo"><i class="fas fa-chevron-right"></i></button>
      </div>

      <div class="ex-past-feature" id="exPastFeature" aria-live="polite"></div>
    </div>
  </section>
  ...
  <section class="ex-gallery-section" id="ex-gallery" aria-label="Expo gallery">
    <div class="ex-gal-atmosphere" aria-hidden="true">
      ...
      <span class="ex-gal-grain"></span>
    </div>

    <div class="ex-gal-wrap">
      <header class="ex-gal-head">
        <span class="ex-gal-kicker"><span class="ex-gal-kicker-line"></span> Moments From The Floor <span class="ex-gal-kicker-line"></span></span>
        <h2>Expo <span>Gallery</span></h2>
        <p>Step inside our global property expos — halls, launches, lounges, and the buyers who made them memorable.</p>
      </header>

      <div class="ex-gal-stage">
        <button type="button" class="ex-gal-nav ex-gal-nav--prev" id="exGalPrev" aria-label="Previous scene"><i class="fas fa-chevron-left"></i></button>

        <div class="ex-gal-viewport-shell">
          <span class="ex-gal-corner ex-gal-corner--tl" aria-hidden="true"></span>
          <span class="ex-gal-corner ex-gal-corner--tr" aria-hidden="true"></span>
          <span class="ex-gal-corner ex-gal-corner--bl" aria-hidden="true"></span>
          <span class="ex-gal-corner ex-gal-corner--br" aria-hidden="true"></span>
        ...
        <button type="button" class="ex-gal-nav ex-gal-nav--next" id="exGalNext" aria-label="Next scene"><i class="fas fa-chevron-right"></i></button>
      </div>
