  ...
  <section class="ex-section ex-upcoming-board" id="ex-upcoming">
    ...
    <div class="ex-wrap">
      ...
      <div class="ex-cal-board">
        ...
        <div class="ex-cal-foot">
          <ul class="ex-cal-stats" aria-label="Expo highlights">
            <li>
              <i class="fas fa-globe-americas" aria-hidden="true"></i>
              <div>
                <strong id="exStatCities">6 Cities</strong>
                <span>Worldwide Expos</span>
              </div>
            </li>
            <li>
          ...
          <button type="button" class="ex-cal-reserve openRegisterModalBtn" id="exCalReserve" data-event="">
            <span class="ex-cal-reserve-copy">
              <strong>Reserve Your Slot</strong>
              <em>Limited slots available</em>
            </span>
            <span class="ex-cal-reserve-go" aria-hidden="true"><i class="fas fa-arrow-right"></i></span>
          </button>
        </div>
